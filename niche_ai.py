...
def _classify(domain: str, meta_text: str, keywords: list) -> dict:
    ...
    prompt = (
        ...
        "Підказки для складних випадків:\n"
        "- Компанія, що РОЗРОБЛЯЄ на замовлення сайти / мобільні застосунки / кастомне ПЗ, "
        "аутсорс/аутстаф, software house, dev-студія → IT-02, а НЕ PROF-05.\n"
        "- PROF-05 (Консалтинг і агенції) — це маркетинг/SEO/реклама/SMM-агенції та бізнес-консалтинг "
        "(вони просувають чужі бізнеси, а не пишуть ПЗ).\n"
        "- IT-01 (SaaS / ПЗ) — лише коли продають готовий програмний продукт за підпискою, "
        "а не послуги розробки.\n\n"
