...
SUB = [
 ...
 ("ELEC-03","ELEC","Інструменти","ECOM",["електроінструмент","ручний інструмент","дриль","дрель","шуруповерт","болгарк","перфоратор","генератор","компресор","набір інструмент","садовий інструмент"]),
 ...
 ("AUTO-01","AUTO","Автодилери","RETAIL",["автосалон","автодилер","автоцентр","офіційний дилер","офіційний представник","купити авто","купить авто","авто з сша","авто з європи","продаж авто","dealership","новий автомобіль","автомобіл","тест-драйв","test drive","модельний ряд","авто з америки","пригон авто","mercedes","mercedes-benz","bmw","audi","volkswagen","skoda","toyota","hyundai","renault","peugeot","nissan","mazda"]),
 ...
 ("PROF-05","PROF","Консалтинг і агенції","SERV",["консалтинг","consulting","маркетингов агенц","агентство","seo послуг","реклам агенц","аутсорсинг персонал","інтернет-маркетинг","интернет-маркетинг","діджитал агенц","digital агенц","digital marketing","веб-студі","веб студі","web студі","просування сайт","продвижение сайт","розкрутка сайт","seo просуванн","seo оптиміз","контекстна реклам","таргетован реклам","smm просуванн","маркетингове агентство","рекламне агентство","створення сайт","розробка сайт"]),
 ...
 ("IT-02","IT","IT-послуги, аутсорс і dev-студії","SERV",["it послуг","it-компан","it компан","розробка сайт","разработка сайт","веб-розробк","веб розробк","web development","software development","software house","розробка застосунк","розробка додатк","аутсорс","аутстаф","outsourcing","outstaff","dev студі","dev-студі","команда розробник","розробка по","розробка мобільн","custom software"]),
...
PODNISA_ALIAS = {
    ...
    "IT-послуги, аутсорс і dev-студії": "IT-послуги й аутсорс",
}
...
# Явні маркери діджитал/веб/маркетинг-агенції — якщо є, ніша однозначно PROF-05
# (агенції треба ловити окремо: їхній контент рясніє чужими нішевими словами).
_AGENCY_STRONG = (
    "інтернет-маркетинг", "интернет-маркетинг", "digital-агенц", "діджитал-агенц",
    "діджитал агенц", "digital агенц", "маркетингов агенц", "рекламн агенц",
    "веб-студі", "веб студі", "web студі", "seo-агенц", "seo агенц",
    "маркетингове агентство", "рекламне агентство", "агенція інтернет",
    "агентство інтернет", "performance marketing", "smm-агенц", "смм-агенц",
)
