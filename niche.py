...
# Економіка ніш: код -> (середня конверсія %, середній чек грн, середня маржа %, тип).
# Джерело: таблиця Elit-Web «3. Довідник піднеш» (бенчмарки 2025 / модельні оцінки UA).
# Для прогнозу лідів, валового доходу та прибутку з SEO-трафіку.
NICHE_ECON = {
    "FASH-01": (2.5, 1300, 55, "Покупка"), "FASH-02": (2.2, 1600, 50, "Покупка"),
    "FASH-03": (2.3, 1400, 55, "Покупка"), "FASH-04": (1.0, 5500, 40, "Покупка"),
    "FASH-05": (2.5, 900, 55, "Покупка"), "FASH-06": (1.8, 1200, 40, "Покупка"),
    "HOME-01": (1.5, 9000, 45, "Покупка"), "HOME-02": (1.4, 7000, 45, "Покупка"),
    "HOME-03": (1.6, 1500, 50, "Покупка"), "HOME-04": (1.5, 4000, 30, "Покупка"),
    "HOME-05": (1.5, 1800, 35, "Покупка"), "HOME-06": (2.5, 1200, 45, "Покупка"),
    "ELEC-01": (1.6, 5500, 15, "Покупка"), "ELEC-02": (2.0, 8000, 18, "Покупка"),
    "ELEC-03": (1.5, 3000, 25, "Покупка"), "ELEC-04": (1.5, 12000, 15, "Покупка"),
    "ELEC-05": (1.6, 7000, 18, "Покупка"), "AUTO-01": (1.5, 700000, 10, "Лід/заявка"),
    "AUTO-02": (1.4, 1500, 30, "Покупка"), "AUTO-03": (1.5, 6000, 25, "Покупка"),
    "AUTO-04": (4.0, 3500, 50, "Лід/заявка"), "AUTO-05": (1.5, 80000, 15, "Покупка"),
    "CONSTR-01": (1.6, 4000, 28, "Покупка"), "CONSTR-02": (2.8, 2500000, 25, "Лід/заявка"),
    "CONSTR-03": (3.5, 150000, 35, "Лід/заявка"), "CONSTR-04": (2.5, 35000, 35, "Лід/заявка"),
    "CONSTR-05": (4.0, 60000, 55, "Лід/заявка"), "BEAUTY-01": (3.5, 1000, 55, "Покупка"),
    "BEAUTY-02": (2.5, 1800, 40, "Покупка"), "BEAUTY-03": (3.2, 1500, 55, "Покупка"),
    "BEAUTY-04": (2.0, 2000, 45, "Покупка"), "BEAUTY-05": (2.5, 700, 30, "Покупка"),
    "MED-01": (3.5, 2500, 40, "Лід/заявка"), "MED-02": (4.0, 5000, 55, "Лід/заявка"),
    "MED-03": (3.5, 4000, 60, "Лід/заявка"), "MED-04": (2.5, 450, 22, "Покупка"),
    "MED-05": (3.0, 1200, 50, "Лід/заявка"), "MED-06": (3.5, 1500, 45, "Лід/заявка"),
    "FOOD-01": (4.0, 500, 65, "Лід/заявка"), "FOOD-02": (4.0, 450, 30, "Покупка"),
    "FOOD-03": (3.5, 700, 22, "Покупка"), "FOOD-04": (3.5, 1200, 30, "Покупка"),
    "FOOD-05": (3.5, 600, 60, "Покупка"), "KIDS-01": (1.6, 1200, 45, "Покупка"),
    "KIDS-02": (2.2, 900, 50, "Покупка"), "KIDS-03": (2.5, 1000, 40, "Покупка"),
    "KIDS-04": (1.8, 2000, 35, "Покупка"), "KIDS-05": (2.5, 500, 30, "Покупка"),
    "KIDS-06": (3.5, 800, 50, "Покупка"), "PROF-01": (7.0, 10000, 45, "Лід/заявка"),
    "PROF-02": (5.0, 5000, 50, "Лід/заявка"), "PROF-03": (4.2, 6000, 40, "Лід/заявка"),
    "PROF-04": (5.0, 8000, 50, "Лід/заявка"), "PROF-05": (5.5, 25000, 50, "Лід/заявка"),
    "PROF-06": (5.0, 30000, 55, "Лід/заявка"), "IT-01": (3.0, 3000, 80, "Лід/заявка"),
    "IT-02": (3.0, 150000, 35, "Лід/заявка"), "IT-03": (2.5, 120000, 40, "Лід/заявка"),
    "IT-04": (3.0, 1500, 55, "Лід/заявка"), "IT-05": (2.5, 50000, 50, "Лід/заявка"),
    "EDU-01": (5.0, 8000, 65, "Лід/заявка"), "EDU-02": (3.0, 40000, 40, "Лід/заявка"),
    "EDU-03": (2.0, 500, 45, "Лід/заявка"), "EDU-04": (5.0, 5000, 75, "Лід/заявка"),
    "EDU-05": (5.0, 4000, 55, "Лід/заявка"), "PERS-01": (4.0, 1200, 55, "Лід/заявка"),
    "PERS-02": (4.0, 1500, 45, "Лід/заявка"), "PERS-03": (4.0, 1500, 50, "Лід/заявка"),
    "PERS-04": (4.0, 1500, 50, "Лід/заявка"), "PERS-05": (4.0, 1500, 55, "Лід/заявка"),
    "TRAVEL-01": (3.0, 40000, 15, "Лід/заявка"), "TRAVEL-02": (2.5, 4000, 55, "Покупка"),
    "TRAVEL-03": (3.0, 1500, 25, "Покупка"), "TRAVEL-04": (3.0, 1000, 50, "Лід/заявка"),
    "SPEC-01": (3.0, 1500, 50, "Реєстрація/лід"), "SPEC-02": (2.5, 800, 75, "Реєстрація/лід"),
    "SPEC-03": (2.0, 700, 70, "Покупка"), "SPEC-04": (2.0, 5000, 50, "Реєстрація/лід"),
}
...
def classify(blob: str, onp: dict = None) -> dict:
    ...
    return {
        ...
        "conv_type": econ[3] if econ else None,
    }
